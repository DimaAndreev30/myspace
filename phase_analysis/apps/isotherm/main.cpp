...
int main(int argc, char* argv[]) {
    ...
    CreatePVCurveByV(file1, C10_nDECANE, NCubicEoS::TPR{}, NCubicEoS::T_ZERO + 200, 1000);
    
    std::ofstream file2("output2.txt");
    CreatePVCurveByP(file2, C10_nDECANE, NCubicEoS::TPR{}, NCubicEoS::T_ZERO + 200, 1000, -100.0, 100.0);
